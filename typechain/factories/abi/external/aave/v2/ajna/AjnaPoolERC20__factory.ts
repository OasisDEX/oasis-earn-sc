...
import type {
  AjnaPoolERC20,
  AjnaPoolERC20Interface,
} from "../../../../../../abi/external/aave/v2/ajna/AjnaPoolERC20";
...
const _abi = [
  ...
  {
    inputs: [],
    name: "LimitIndexReached",
    type: "error",
  },
  {
    inputs: [],
    name: "MoveToSamePrice",
    type: "error",
  },
  {
    inputs: [],
...
export class AjnaPoolERC20__factory {
  static readonly abi = _abi;
  static createInterface(): AjnaPoolERC20Interface {
    return new utils.Interface(_abi) as AjnaPoolERC20Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AjnaPoolERC20 {
    return new Contract(address, _abi, signerOrProvider) as AjnaPoolERC20;
  }
}
