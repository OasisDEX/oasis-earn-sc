<<<<<<<< HEAD:packages/dupa-library/test/service-registry.test.ts
import { ContractNames } from '@dupa-library/src/utils/constants'
...
>>>>>>>> dev:test/unit/core/serviceRegistry.test.ts
