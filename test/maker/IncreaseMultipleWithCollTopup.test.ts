...
describe(`Operations | Maker | ${OPERATION_NAMES.maker.INCREASE_MULTIPLE_WITH_COLL_TOP_UP}`, async () => {
  ...
  const testName = `should open vault, deposit ETH and increase multiple & [+Coll topup]`
  it(testName, async () => {
    await WETH.approve(
