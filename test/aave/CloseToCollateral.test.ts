...
import { AavePositionBalance } from '@oasisdex/oasis-actions/src/strategies/types/aave/AavePosition'
...
import { getSystemWithAAVEPosition, SystemWithAAVEPosition } from '../fixtures'
