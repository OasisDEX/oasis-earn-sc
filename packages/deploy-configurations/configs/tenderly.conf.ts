  ...
  mpa: {
    core: {
      ServiceRegistry: {
        ...
        deploy: true,
        address: '0x86Ec9e6182da8567F77add3fdc80dBB9Dfaa4d21',
        history: [],
        constructorArgs: [ 0 ]
      },
      OperationExecutor: {
        ...
        deploy: true,
        address: '0x076CbD48013EbFC20d563339c7d6cd45376Ec2b8',
      ...
      OperationStorage: {
        ...
        deploy: true,
        address: '0x750d660ceF64414BeA656351D63AF2E5fff78984',
      ...
      OperationsRegistry: {
        ...
        deploy: true,
        address: '0x02cEf388ef95984b967DDabAc4d4eFEe1Ca4884a',
      ...
      DSProxyFactory: {
        name: 'DSProxyFactory',
        deploy: true,
        address: '0xFd8238e38E96A9De5d080Ee89892c5625B8ceED2',
      ...
      DSProxyRegistry: {
        ...
        deploy: true,
        address: '0x3c58266ee56a7e25E246A3e3e9b56Dbf934660b9',
      ...
      DSGuardFactory: {
        name: 'DSGuardFactory',
        deploy: true,
        address: '0x45FdE3DF7f56C4Ef6aD3758fc834bCd4e922Da3e',
      ...
      AccountGuard: {
        name: 'AccountGuard',
        deploy: true,
        address: '0xe44Bf06Eb7CdE41fF223Aa88ED718eE8720AaAC0',
        history: [],
        constructorArgs: []
      },
      AccountFactory: {
        name: 'AccountFactory',
        deploy: true,
        address: '0x28e9d231BC09AC4D2F317186f69B3Ff2e686EB56',
        history: [],
      ...
      ChainLogView: {
        name: 'ChainLogView',
        deploy: true,
        address: '0xe4398A7FeE350ec624d6fb6a00D98D00aA2F953E',
      ...
      Swap: {
        name: 'Swap',
        deploy: true,
        address: '0xdC6C09D32a67aB236CFC28ec428E447b9De10f6D',
    ...
    actions: {
      PositionCreated: {
        ...
        deploy: true,
        address: '0xf728c2e806D27028753B70383b7DfD4618198F47',
      ...
      SwapAction: {
        name: 'SwapAction',
        deploy: true,
        address: '0x63676dEb4E474b9DDC5b34a004b1A91f59f1e948',
      ...
      TakeFlashloan: {
        name: 'TakeFlashloan',
        deploy: true,
        address: '0x29201EbAe087A8689Cd1D988198F879526b0aFa0',
      ...
      SetApproval: {
        name: 'SetApproval',
        deploy: true,
        address: '0xDe39dE09dB09E1d78c3a2F6b101dd5FC37180E9c',
      ...
      PullToken: {
        name: 'PullToken',
        deploy: true,
        address: '0xb8690cCdF17Ed2742B1c4A7357e1b9239fCA0Ddc',
      ...
      SendToken: {
        name: 'SendToken',
        deploy: true,
        address: '0x3a9bA2a1c5e6d6b551786659E6C2F51Bc6E34Db9',
      ...
      WrapEth: {
        name: 'WrapEth',
        deploy: true,
        address: '0xc0fdd670F9CD133930827D5e1F6F4AF6A92Ef500',
      ...
      UnwrapEth: {
        name: 'UnwrapEth',
        deploy: true,
        address: '0x941e96a0c8D7c6C6084Ad78eCc189184B08EeAd8',
      ...
      ReturnFunds: {
        name: 'ReturnFunds',
        deploy: true,
        address: '0x29acA9783fEf898a2df0C37fc1Af9bACD0741aDf',
      ...
      AaveBorrow: {
        name: 'AaveBorrow',
        deploy: true,
        address: '0x398AF385f1ed7fd66bfF2cc4316b3804EdFd35da',
      ...
      AaveWithdraw: {
        name: 'AaveWithdraw',
        deploy: true,
        address: '0xCf4E62D2c48F9a64D1bfe7b7333EfED7a39321EA',
      ...
      AaveDeposit: {
        name: 'AaveDeposit',
        deploy: true,
        address: '0xa8a3E14A8B7125C9a7e34134bf6fc661B3271D31',
      ...
      AavePayback: {
        name: 'AavePayback',
        deploy: true,
        address: '0x48b43a3a2Bd930483E93469364cE636ee47b8887',
      ...
      AaveV3Borrow: {
        name: 'AaveV3Borrow',
        deploy: true,
        address: '0xC57A5AB7DA77ca73A2E170A22a313b9e85112EA4',
      ...
      AaveV3Withdraw: {
        name: 'AaveV3Withdraw',
        deploy: true,
        address: '0x7fc4Fa663f1966756ec2b4C2E17A97Ae6f9f39E2',
      ...
      AaveV3Deposit: {
        name: 'AaveV3Deposit',
        deploy: true,
        address: '0x10D1877a89D53ae2147A31B00484A338595F75C6',
      ...
      AaveV3Payback: {
        name: 'AaveV3Payback',
        deploy: true,
        address: '0xC013cd25fEDe359722813246bbFa344398eCFdEb',
      ...
      AaveV3SetEMode: {
        name: 'AaveV3SetEMode',
        deploy: true,
        address: '0x284d3081e82B9b95AA50c373b9821863CF7FF2F9',
      ...
      AjnaDepositBorrow: {
        ...
        deploy: true,
        address: '0x46c72924562DBb28Cec6785109206a985Ae7eE6D',
      ...
      AjnaRepayWithdraw: {
        ...
        deploy: true,
        address: '0xA714AEe32CD99b714DE2b64C5ba417fC2f737341',
      ...
      MorphoBlueBorrow: {
        ...
        deploy: true,
        address: '0x42fC23d6041aAC814bFEc92DAD79f638E90aF98a',
      ...
      MorphoBlueWithdraw: {
        ...
        deploy: true,
        address: '0x702F8fb23841Ad7AbB4F078bf39973a0051ECE60',
      ...
      MorphoBlueDeposit: {
        ...
        deploy: true,
        address: '0xa2783954277EE81d80f449E6C554f739fC4FEb79',
      ...
      MorphoBluePayback: {
        ...
        deploy: true,
        address: '0xcdD705F7607D47d47284B60084232Eb3c8974418',
