  ...
  mpa: {
    core: {
      ...
      OperationsRegistry: {
        ...
        deploy: false,
        address: '0xc09BC3356DA0350D7ad236e1250Fc06D62440A05',
      ...
      OperationExecutor: {
        ...
        constructorArgs: [
          ...
          '0x0000000000000000000000000000000000000000', // no chainLogView on Base because no FMM on base
    ...
    actions: {
      ...
      SwapAction: {
        name: 'SwapAction',
        deploy: false,
        address: '0x7f3C01B83DfC1935c4f80B270982e6Ea91AD4047',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.common.SWAP_ACTION,
        history: ['0x663A9525ffE09b736eb153092c90aaB144eDBa03'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      TakeFlashloan: {
        name: 'TakeFlashloan',
        deploy: false,
        address: '0xB5CD6E322De1798A9C409Cb86e86C0CA5aeA37f9',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.common.TAKE_A_FLASHLOAN,
        history: ['0x0d8e5D7A5B45Ce86a75489C7166dF69C9f453D0A'],
        constructorArgs: [
          'address:ServiceRegistry',
      ...
      SetApproval: {
        ...
        history: ['0x35e847e3dAD2847C9E39196FCbF1c057b32c6469'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      PullToken: {
        name: 'PullToken',
        ...
        history: ['0x52a9bC9a904B9eE6A4714eF883cCf14cb7283B0F'],
        constructorArgs: [],
      },
      SendToken: {
        name: 'SendToken',
        ...
        history: ['0x98191F148AC0A1EaB75315989b357D83d728Fc43'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      WrapEth: {
        name: 'WrapEth',
        ...
        history: ['0x499afBC7aE808e51e48A29FD30e80DfC5B1F2e56'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      UnwrapEth: {
        name: 'UnwrapEth',
      ...
      ReturnFunds: {
        ...
        history: ['0xC58F2Ee4Ef92F2bE314743442496D6Fad0339d56'],
        constructorArgs: [],
      },
      AaveV3Borrow: {
        name: 'AaveV3Borrow',
      ...
      AaveV3Withdraw: {
        ...
        history: ['0xFBcB0bf3A7BcD1a368e8e8Ad2Ab601160088b39C'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3WithdrawAuto: {
      ...
      AaveV3Deposit: {
        ...
        history: ['0x53546083A3C8841e0813C6800e19F7E736585D31'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AaveV3Payback: {
        name: 'AaveV3Payback',
      ...
      AaveV3SetEMode: {
        ...
        history: ['0x9F47b484E921619028eF1c6F7fE73F9921B5AC6D'],
        constructorArgs: ['address:ServiceRegistry'],
      },
      AjnaDepositBorrow: {
