...
export const config: SystemConfig = {
    ...
    core: {
      ServiceRegistry: {
        ...
        history: [
          ...
          '0xc6a15814fEFaf471301163AE0a65cDaC48BB2D4d'
        ],
        constructorArgs: [ 0 ]
      },
      OperationExecutor: {
        ...
        history: [
          ...
          '0xCD8B4a7Dd87F56B598B5e64ddFB0Ae5AC20C4116'
        ],
      ...
      OperationStorage: {
        ...
        history: [
          ...
          '0xa593F8228a1f0e4acCcEb1C59E90b7047fFdD09D'
        ],
      ...
      OperationsRegistry: {
        ...
        history: [
          ...
          '0x14912c49CF9ee1AbdFEc50D067ef083b34423Aa4'
        ],
        constructorArgs: []
      },
      DSProxyFactory: {
        ...
        history: [
          ...
          '0x2F92aC7c2D18bE332eb99e37368a62AeDDA47096'
        ],
        constructorArgs: []
      },
      DSProxyRegistry: {
        ...
        history: [
          ...
          '0xF62792655858FA180F5ADcE43E2758B1E45eCb9a'
        ],
      ...
      DSGuardFactory: {
        ...
        history: [
          ...
          '0x2B2E1c7F5Ab4af209cb9804aFaD2FE694A7ef07f'
        ],
        constructorArgs: []
      },
      AccountGuard: {
        ...
        history: [
          ...
          '0x998AA1d798a30Ed6E864c503e006189e63979B3C'
        ],
        constructorArgs: []
      },
      AccountFactory: {
        ...
        history: [
          ...
          '0x280C53b52a4ecbB0A2F2f5d0A10B354600c71602'
        ],
      ...
      ChainLogView: {
        ...
        history: [
          ...
          '0x3C0Ac1a4F89d227DB52115828FAe7085f8686Dc0'
        ],
      ...
      Swap: {
        name: 'uSwap',
        deploy: true,
        address: '0x436Af5D447E5Ce6341676D4E3d87bE6C52ea0d56',
    ...
    actions: {
      PositionCreated: {
        ...
        history: [
          ...
          '0x662ED0EFFC9E3BdF50D9118ffaC2197590CA169E'
        ],
        constructorArgs: []
      },
      SwapAction: {
        ...
        history: [
          ...
          '0x9124523d32E881697bd65e43e78B1f7Be71cb00C'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      TakeFlashloan: {
        ...
        history: [
          ...
          '0x373857dFe57F0B894f06aF9B16aBF46a28bB3908'
        ],
        constructorArgs: [
          'address:ServiceRegistry',
      ...
      AavePayback: {
        ...
        history: [
          ...
          '0xafF4e03FE547584fFf0cE8Be05A9421aFfc17475'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3Borrow: {
        ...
        history: [
          ...
          '0xA9EE1fC2EBc036FA5c367E54D6cE5e584c4b7171'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3Withdraw: {
        ...
        history: [
          ...
          '0xffC93836c2F52382B94685bB403bAaD953b1c21f'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3Deposit: {
        ...
        history: [
          ...
          '0xd67E801DCABD681AdCA12019567D1a03a2631A63'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3Payback: {
        ...
        history: [
          ...
          '0x30D2906b583EEcB958a6C6DeFfb3C0521aB467D2'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AaveV3SetEMode: {
        ...
        history: [
          ...
          '0x095c2BFC7f8934e5Ae801477afeC0c1e962Cb3ae'
        ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AjnaDepositBorrow: {
        ...
        history: [ '0x301ad2479EE3B12802F4a8aD8dCd803E5e6C1436' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      AjnaRepayWithdraw: {
        name: 'AjnaRepayWithdraw',
        deploy: true,
        address: '0x4E5c6dd0FFDa3a6aA3F7461CAdf30be63F175327',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.ajna.REPAY_WITHDRAW,
        history: [ '0xF108CE1A3E5C6CB67E16120CCdC637E844B4DcBF' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      }
    }
  },
  ...
  ajna: {
    AjnaPoolInfo: {
      name: 'AjnaPoolInfo',
      address: '0xf0f5b689d27365C18fbdFB9bc499708a19b56Fb5',
      serviceRegistryName: SERVICE_REGISTRY_NAMES.ajna.AJNA_POOL_UTILS_INFO
    },
    AjnaProxyActions: {
      name: 'AjnaProxyActions',
      address: '0x2156315Ac14E2388225C33FB216eC57962A3df99'
    },
