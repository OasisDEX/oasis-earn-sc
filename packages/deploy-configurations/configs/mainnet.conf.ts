  ...
  mpa: {
    ...
    actions: {
      ...
      MakerPayback: {
        name: 'MakerPayback',
        deploy: true,
        address: '0x1C843ccE54B83BBd89cfd2478E17B4AB26A17dEc',
        serviceRegistryName: SERVICE_REGISTRY_NAMES.maker.PAYBACK,
        history: [ '0xFa7facB6dfa38c29bB0C9dC011c8bE8bc197Cf26' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      },
      MakerWithdraw: {
        name: 'MakerWithdraw',
        ...
        history: [ '0x4c0eB46fb2a26129ba5e666fc6E03b8c8aA4728e' ],
        constructorArgs: [ 'address:ServiceRegistry' ]
      }
    }
  },
