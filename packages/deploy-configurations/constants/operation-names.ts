...
export const OPERATION_NAMES = {
  ...
  ajna: {
    OPEN_MULTIPLY_POSITION: 'AjnaOpenMultiplyPosition_3',
    ADJUST_RISK_UP: 'AjnaAdjustRiskUp_3',
    ADJUST_RISK_DOWN: 'AjnaAdjustRiskDown_3',
    DEPOSIT_BORROW: 'AjnaDepositBorrow_3',
    PAYBACK_WITHDRAW: 'AjnaPaybackWithdraw_3',
    CLOSE_POSITION_TO_QUOTE: 'AjnaCloseToQuotePosition_3',
    CLOSE_POSITION_TO_COLLATERAL: 'AjnaCloseToCollateralPosition_3',
  },
  morphoblue: {
