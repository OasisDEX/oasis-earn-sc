...
export const OPERATION_NAMES = {
  ...
  ajna: {
    OPEN_MULTIPLY_POSITION: 'AjnaOpenMultiplyPosition_4',
    ADJUST_RISK_UP: 'AjnaAdjustRiskUp_4',
    ADJUST_RISK_DOWN: 'AjnaAdjustRiskDown_4',
    DEPOSIT_BORROW: 'AjnaDepositBorrow_4',
    PAYBACK_WITHDRAW: 'AjnaPaybackWithdraw_4',
    CLOSE_POSITION_TO_QUOTE: 'AjnaCloseToQuotePosition_4',
    CLOSE_POSITION_TO_COLLATERAL: 'AjnaCloseToCollateralPosition_4',
  },
  morphoblue: {
