...
export const OPERATION_NAMES = {
  ...
  ajna: {
    OPEN_MULTIPLY_POSITION: 'AjnaOpenMultiplyPosition_2',
    ADJUST_RISK_UP: 'AjnaAdjustRiskUp_2',
    ADJUST_RISK_DOWN: 'AjnaAdjustRiskDown_2',
    DEPOSIT_BORROW: 'AjnaDepositBorrow_2',
    PAYBACK_WITHDRAW: 'AjnaPaybackWithdraw_2',
    CLOSE_POSITION_TO_QUOTE: 'AjnaCloseToQuotePosition_2',
    CLOSE_POSITION_TO_COLLATERAL: 'AjnaCloseToCollateralPosition_2',
  },
  morphoblue: {
