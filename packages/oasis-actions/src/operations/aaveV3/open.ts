...
import { Address, IOperation, PositionType, Protocol } from '../../strategies/types'
...
export async function openV3({
  ...
  console.log('OPENING V3 Operation')
  ...
  console.log('CALLS', [takeAFlashLoan])

  return {
    calls: [takeAFlashLoan],
    operationName: OPERATION_NAMES.aaveV3.OPEN_POSITION,
  }
}
