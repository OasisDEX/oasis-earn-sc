...
export async function open(
  ...
  await aavePriceOracle
      .getAssetPrice(ADDRESSES.goerli.USDC)
      
      console.log('1111AAAA', );
      
      await aavePriceOracle.getAssetPrice(debtTokenAddress)
      
      console.log('2222AAAA', );
      await aavePriceOracle.getAssetPrice(collateralTokenAddress)
      
      console.log('3333AAAA', );
      
      await aaveProtocolDataProvider.getReserveConfigurationData(ADDRESSES.goerli.USDC)
      console.log('4444AAAA', );
  ...
  const [
    ...
    aavePriceOracle
      ...
      .then((amount: ethers.BigNumberish) => amountFromWei(new BigNumber(amount.toString()))),
    aaveProtocolDataProvider.getReserveConfigurationData(ADDRESSES.goerli.USDC),
  ...
  console.log('IIIII', args );

  const operation = await operations.aaveV3.open({
    deposit: {
      collateralToken: {
