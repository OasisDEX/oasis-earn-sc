export const calldataTypes = {
  common: {
    ...
    TakeAFlashLoan: `tuple(uint256 amount, address asset, bool isProxyFlashloan, bool isDPMProxy, uint256 provider, (bytes32 targetHash, bytes callData, bool skipped)[] calls)`,
  },
  maker: {
