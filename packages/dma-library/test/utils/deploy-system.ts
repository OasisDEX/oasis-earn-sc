...
import { logDebug } from '@oasisdex/dma-common/utils/common'
...
import { loadDummyExchangeFixtures } from '@dma-library/test/utils/dummy-exchange'
...
export async function deploySystem(config: RuntimeConfig, debug = false, useFallbackSwap = true) {
  ...
  debug && console.log('2/ Deploying system dma-contracts')
  ...
  debug && console.log('4/ Adding dma-contracts to registry')
