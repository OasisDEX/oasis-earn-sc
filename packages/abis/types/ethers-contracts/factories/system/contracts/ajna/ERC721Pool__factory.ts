...
import type {
  ERC721Pool,
  ERC721PoolInterface,
} from "../../../../system/contracts/ajna/ERC721Pool";
...
export class ERC721Pool__factory {
  ...
  static createInterface(): ERC721PoolInterface {
    return new Interface(_abi) as ERC721PoolInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC721Pool {
    return new Contract(address, _abi, runner) as unknown as ERC721Pool;
  }
}
