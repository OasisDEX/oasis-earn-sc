...
export class PoolCommons__factory {
  ...
  static createInterface(): PoolCommonsInterface {
    return new Interface(_abi) as PoolCommonsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): PoolCommons {
    return new Contract(address, _abi, runner) as unknown as PoolCommons;
  }
}
