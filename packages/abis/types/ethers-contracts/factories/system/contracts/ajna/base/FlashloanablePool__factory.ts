...
import type {
  FlashloanablePool,
  FlashloanablePoolInterface,
} from "../../../../../system/contracts/ajna/base/FlashloanablePool";
...
export class FlashloanablePool__factory {
  static readonly abi = _abi;
  static createInterface(): FlashloanablePoolInterface {
    return new utils.Interface(_abi) as FlashloanablePoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): FlashloanablePool {
    return new Contract(address, _abi, signerOrProvider) as FlashloanablePool;
  }
}
