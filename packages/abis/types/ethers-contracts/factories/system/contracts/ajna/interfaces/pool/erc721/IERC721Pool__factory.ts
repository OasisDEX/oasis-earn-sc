...
export class IERC721Pool__factory {
  ...
  static createInterface(): IERC721PoolInterface {
    return new Interface(_abi) as IERC721PoolInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IERC721Pool {
    return new Contract(address, _abi, runner) as unknown as IERC721Pool;
  }
}
