...
import type {
  ERC20Pool,
  ERC20PoolInterface,
} from "../../../../system/contracts/ajna/ERC20Pool";
...
export class ERC20Pool__factory {
  ...
  static createInterface(): ERC20PoolInterface {
    return new Interface(_abi) as ERC20PoolInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): ERC20Pool {
    return new Contract(address, _abi, runner) as unknown as ERC20Pool;
  }
}
