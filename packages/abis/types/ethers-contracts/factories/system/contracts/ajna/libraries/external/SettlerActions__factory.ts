...
import type {
  SettlerActions,
  SettlerActionsInterface,
} from "../../../../../../system/contracts/ajna/libraries/external/SettlerActions";
...
export class SettlerActions__factory {
  static readonly abi = _abi;
  static createInterface(): SettlerActionsInterface {
    return new utils.Interface(_abi) as SettlerActionsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): SettlerActions {
    return new Contract(address, _abi, signerOrProvider) as SettlerActions;
  }
}
