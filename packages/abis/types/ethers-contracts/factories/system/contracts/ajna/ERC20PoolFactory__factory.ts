...
import type {
  ERC20PoolFactory,
  ERC20PoolFactoryInterface,
} from "../../../../system/contracts/ajna/ERC20PoolFactory";
...
export class ERC20PoolFactory__factory {
  ...
  static createInterface(): ERC20PoolFactoryInterface {
    return new Interface(_abi) as ERC20PoolFactoryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): ERC20PoolFactory {
    return new Contract(address, _abi, runner) as unknown as ERC20PoolFactory;
  }
}
