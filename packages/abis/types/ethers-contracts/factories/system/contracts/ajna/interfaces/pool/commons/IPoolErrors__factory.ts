...
export class IPoolErrors__factory {
  ...
  static createInterface(): IPoolErrorsInterface {
    return new Interface(_abi) as IPoolErrorsInterface;
  }
  static connect(address: string, runner?: ContractRunner | null): IPoolErrors {
    return new Contract(address, _abi, runner) as unknown as IPoolErrors;
  }
}
