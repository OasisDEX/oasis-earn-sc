...
} from "../../../../system/contracts/ajna/RewardsManager";
...
export class RewardsManager__factory {
  ...
  static createInterface(): RewardsManagerInterface {
    return new Interface(_abi) as RewardsManagerInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): RewardsManager {
    return new Contract(address, _abi, runner) as unknown as RewardsManager;
  }
}
