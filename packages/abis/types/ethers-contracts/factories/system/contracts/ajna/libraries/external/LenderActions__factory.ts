...
import type {
  LenderActions,
  LenderActionsInterface,
} from "../../../../../../system/contracts/ajna/libraries/external/LenderActions";
...
export class LenderActions__factory {
  static readonly abi = _abi;
  static createInterface(): LenderActionsInterface {
    return new utils.Interface(_abi) as LenderActionsInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LenderActions {
    return new Contract(address, _abi, signerOrProvider) as LenderActions;
  }
}
