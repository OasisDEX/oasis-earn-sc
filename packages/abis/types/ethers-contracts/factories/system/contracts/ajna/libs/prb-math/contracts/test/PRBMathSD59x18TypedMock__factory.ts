...
import type {
  ...
  PRBMathSD59x18TypedMockInterface,
} from "../../../../../../../../system/contracts/ajna/libs/prb-math/contracts/test/PRBMathSD59x18TypedMock";
...
export class PRBMathSD59x18TypedMock__factory {
  static readonly abi = _abi;
  static createInterface(): PRBMathSD59x18TypedMockInterface {
    return new Interface(_abi) as PRBMathSD59x18TypedMockInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as PRBMathSD59x18TypedMock;
  }
}
