...
} from "../../../../system/contracts/ajna/PoolInfoUtils";
...
export class PoolInfoUtils__factory {
  ...
  static createInterface(): PoolInfoUtilsInterface {
    return new Interface(_abi) as PoolInfoUtilsInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PoolInfoUtils {
    return new Contract(address, _abi, runner) as unknown as PoolInfoUtils;
  }
}
