...
} from "../../../protocols/spark/PoolDataProvider";
...
export class PoolDataProvider__factory {
  ...
  static createInterface(): PoolDataProviderInterface {
    return new Interface(_abi) as PoolDataProviderInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): PoolDataProvider {
    return new Contract(address, _abi, runner) as unknown as PoolDataProvider;
  }
}
