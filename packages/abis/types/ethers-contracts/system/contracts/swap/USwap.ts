...
export interface USwapInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addFeeTier"
      | "authorizedAddresses"
...
export interface USwap extends BaseContract {
  connect(runner?: ContractRunner | null): USwap;
  waitForDeployment(): Promise<this>;

  interface: USwapInterface;
  ...
  decodeOneInchCallData: TypedContractMethod<
    [withData: BytesLike],
    [bigint],
    "view"
  >;
  ...
  pools: TypedContractMethod<[arg0: BytesLike], [bigint], "view">;

  removeFeeTier: TypedContractMethod<[fee: BigNumberish], [void], "nonpayable">;

  setPool: TypedContractMethod<
    [fromToken: AddressLike, toToken: AddressLike, pool: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "decodeOneInchCallData"
  ): TypedContractMethod<[withData: BytesLike], [bigint], "view">;
  getFunction(
