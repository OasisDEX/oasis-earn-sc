...
export interface IERC721PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "addQuoteToken"
...
export interface IERC721Pool extends BaseContract {
  connect(runner?: ContractRunner | null): IERC721Pool;
  waitForDeployment(): Promise<this>;

  interface: IERC721PoolInterface;
