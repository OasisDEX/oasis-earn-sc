...
export interface IERC20PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "addQuoteToken"
...
export interface IERC20Pool extends BaseContract {
  connect(runner?: ContractRunner | null): IERC20Pool;
  waitForDeployment(): Promise<this>;

  interface: IERC20PoolInterface;
