...
export interface IRewardsManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "calculateRewards"
      | "claimRewards"
...
export interface IRewardsManager extends BaseContract {
  connect(runner?: ContractRunner | null): IRewardsManager;
