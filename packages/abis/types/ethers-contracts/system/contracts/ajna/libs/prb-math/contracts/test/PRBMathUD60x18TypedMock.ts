...
export interface PRBMathUD60x18TypedMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "doAdd"
      | "doAvg"
...
export interface PRBMathUD60x18TypedMock extends BaseContract {
  connect(runner?: ContractRunner | null): PRBMathUD60x18TypedMock;
  waitForDeployment(): Promise<this>;

  interface: PRBMathUD60x18TypedMockInterface;
