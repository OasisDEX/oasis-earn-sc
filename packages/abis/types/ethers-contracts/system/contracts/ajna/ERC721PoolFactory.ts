...
export interface ERC721PoolFactoryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface ERC721PoolFactory extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721PoolFactory;
  ...
  ERC721_NON_SUBSET_HASH: TypedContractMethod<[], [string], "view">;
  ...
  "deployPool(address,address,uint256)": TypedContractMethod<
    [
  ...
  "deployPool(address,address,uint256[],uint256)": TypedContractMethod<
    [
      collateral_: AddressLike,
      quote_: AddressLike,
  ...
  getNFTSubsetHash: TypedContractMethod<
    [tokenIds_: BigNumberish[]],
    [string],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "ERC721_NON_SUBSET_HASH"
  ...
  getFunction(
    nameOrSignature: "deployPool(address,address,uint256)"
  ): TypedContractMethod<
    [
      collateral_: AddressLike,
      quote_: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "deployPool(address,address,uint256[],uint256)"
  ): TypedContractMethod<
    [
      collateral_: AddressLike,
      quote_: AddressLike,
  ...
  getFunction(
    nameOrSignature: "getNFTSubsetHash"
  ): TypedContractMethod<[tokenIds_: BigNumberish[]], [string], "view">;
  getFunction(
