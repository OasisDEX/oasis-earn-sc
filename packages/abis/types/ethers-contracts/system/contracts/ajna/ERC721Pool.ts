...
export interface ERC721PoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "addQuoteToken"
...
export interface ERC721Pool extends BaseContract {
  connect(runner?: ContractRunner | null): ERC721Pool;
  ...
  bucketTokenIds: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  initialize: TypedContractMethod<
    [tokenIds_: BigNumberish[], rate_: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  removeCollateral: TypedContractMethod<
    [noOfNFTsToRemove_: BigNumberish, index_: BigNumberish],
  ...
  ): TypedContractMethod<[tokenId_: BigNumberish], [boolean], "view">;
  getFunction(
