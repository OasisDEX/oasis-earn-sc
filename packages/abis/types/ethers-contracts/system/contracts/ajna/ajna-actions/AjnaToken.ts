...
export interface AjnaTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface AjnaToken extends BaseContract {
  connect(runner?: ContractRunner | null): AjnaToken;
  ...
  transferFromWithPermit: TypedContractMethod<
    [
      from_: AddressLike,
      to_: AddressLike,
  ...
  >;
  getFunction(
    nameOrSignature: "transferFromWithPermit"
  ): TypedContractMethod<
    [
      from_: AddressLike,
      to_: AddressLike,
