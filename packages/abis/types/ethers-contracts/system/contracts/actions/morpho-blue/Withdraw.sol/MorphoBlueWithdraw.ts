...
export type WithdrawDataStructOutput = [
  ...
  BigNumber,
  string
] & { marketParams: MarketParamsStructOutput; amount: BigNumber; to: string };

export interface MorphoBlueWithdrawInterface extends utils.Interface {
  functions: {
...
export interface MorphoBlueWithdraw extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MorphoBlueWithdrawInterface;
