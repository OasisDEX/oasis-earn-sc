...
export type DepositDataStructOutput = [
  ...
  vaultId: bigint,
  amount: bigint
] & { joinAddress: string; vaultId: bigint; amount: bigint };

export interface MakerDepositInterface extends Interface {
...
export interface MakerDeposit extends BaseContract {
  connect(runner?: ContractRunner | null): MakerDeposit;
