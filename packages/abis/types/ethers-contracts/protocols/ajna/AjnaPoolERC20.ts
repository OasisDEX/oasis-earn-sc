...
export interface AjnaPoolERC20Interface extends Interface {
  getFunction(
    nameOrSignature:
      | "addCollateral"
      | "addQuoteToken"
...
export interface AjnaPoolERC20 extends BaseContract {
  connect(runner?: ContractRunner | null): AjnaPoolERC20;
  ...
  addQuoteToken: TypedContractMethod<
    [amount_: BigNumberish, index_: BigNumberish, expiry_: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  bucketCollateralDust: TypedContractMethod<
  ...
  initialize: TypedContractMethod<[rate_: BigNumberish], [void], "nonpayable">;
  ...
  kickWithDeposit: TypedContractMethod<
  ...
  quoteTokenDust: TypedContractMethod<[], [bigint], "view">;
  ...
  repayDebt: TypedContractMethod<
    [
      ...
      collateralReceiver_: AddressLike,
      limitIndex_: BigNumberish
    ],
    [void],
    "nonpayable"
  ...
  >;
  getFunction(
    nameOrSignature: "bucketCollateralDust"
  ): TypedContractMethod<[bucketIndex_: BigNumberish], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "kickWithDeposit"
  ): TypedContractMethod<
    [index_: BigNumberish, npLimitIndex_: BigNumberish],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "quoteTokenDust"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
