...
async function main() {
  ...
  await ajnaEnv.provideLiquidity(ajnaEnv.pools.wbtcUsdcPool, hre.ethers.BigNumber.from(1000000), await ajnaEnv.poolInfo.priceToIndex(hre.ethers.utils.parseEther('15000')))
  await ajnaEnv.provideLiquidity(ajnaEnv.pools.wethUsdcPool, hre.ethers.BigNumber.from(100000), await ajnaEnv.poolInfo.priceToIndex(hre.ethers.utils.parseEther('1200')))
