...
exports.mainnetConfig = {
    mpa: {
        core: {
            ...
            DSProxyFactory: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.common.DS_PROXY_FACTORY,
                history: [],
                constructorArgs: [],
            },
            DSProxyRegistry: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.common.DS_PROXY_REGISTRY,
                history: [],
            ...
            DSGuardFactory: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.common.DS_GUARD_FACTORY,
                history: [],
                constructorArgs: [],
            },
            AccountGuard: {
            ...
            ChainLogView: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.maker.CHAINLOG_VIEW,
                history: [],
    ...
    common: {
        ...
        UniswapRouterV3: {
            ...
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.UNISWAP_ROUTER,
        },
        BalancerVault: {
            name: 'BalancerVault',
            address: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.BALANCER_VAULT,
        },
        OneInchAggregator: {
            name: 'OneInchAggregator',
            address: '0x1111111254fb6c44bac0bed2854e76f90643097d',
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.ONE_INCH_AGGREGATOR,
        },
        AuthorizedCaller: {
        ...
        DAI: {
            ...
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.DAI,
        },
        ...
        STETH: {
            ...
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.STETH,
        },
        ...
        USDC: {
            ...
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.USDC,
        },
        USDT: { name: 'USDT', address: '0xdAC17F958D2ee523a2206206994597C13D831ec7' },
        WBTC: {
            name: 'WBTC',
            address: '0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599',
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.WBTC,
        },
        WETH: {
            name: 'WETH',
            address: '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2',
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.WETH,
        },
        WSTETH: {
            name: 'WSTETH',
            address: '0x7f39c581f595b53c5cb19bd0b3f8da6c935e2ca0',
            serviceRegistryName: constants_1.CONTRACT_NAMES.common.WSTETH,
        },
    ...
    aave: {
        v2: {
            ...
            LendingPool: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.aave.v2.LENDING_POOL,
            },
            ...
            WETHGateway: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.aave.v2.WETH_GATEWAY,
            },
        },
        v3: {
            AaveOracle: {
            ...
            Pool: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.aave.v3.AAVE_POOL,
            },
    ...
    maker: {
        common: {
            FlashMintModule: {
                ...
                serviceRegistryName: constants_1.CONTRACT_NAMES.maker.FLASH_MINT_MODULE,
            },
            Chainlog: {
                name: 'Chainlog',
                address: '0x60744434d6339a6B27d73d9Eda62b6F66a0a04FA',
