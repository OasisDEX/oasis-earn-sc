...
exports.config = {
    ...
    common: {
        GnosisSafe: {
            name: 'GnosisSafe',
            address: constants_1.ADDRESS_ZERO,
        },
        UniswapRouterV3: {
        ...
        ADAI: { name: 'ADAI', address: constants_1.ADDRESS_ZERO },
        AAVE: { name: 'AAVE', address: constants_1.ADDRESS_ZERO },
        BAL: { name: 'BAL', address: constants_1.ADDRESS_ZERO },
        BAT: { name: 'BAT', address: constants_1.ADDRESS_ZERO },
        COMP: { name: 'COMP', address: constants_1.ADDRESS_ZERO },
        CRVV1ETHSTETH: { name: 'CRVV1ETHSTETH', address: constants_1.ADDRESS_ZERO },
        DAI: {
            name: 'DAI',
            address: constants_1.ADDRESS_ZERO,
            serviceRegistryName: 'DAI',
        },
        ETH: { name: 'ETH', address: constants_1.ADDRESS_ZERO },
        GNO: { name: 'GNO', address: constants_1.ADDRESS_ZERO },
        GUNIV3DAIUSDC1: {
            name: 'GUNIV3DAIUSDC1',
            address: constants_1.ADDRESS_ZERO,
        },
        ...
        GUSD: { name: 'GUSD', address: constants_1.ADDRESS_ZERO },
        KNC: { name: 'KNC', address: constants_1.ADDRESS_ZERO },
        LDO: { name: 'LDO', address: constants_1.ADDRESS_ZERO },
        LINK: { name: 'LINK', address: constants_1.ADDRESS_ZERO },
        LRC: { name: 'LRC', address: constants_1.ADDRESS_ZERO },
        MANA: { name: 'MANA', address: constants_1.ADDRESS_ZERO },
        MATIC: { name: 'MATIC', address: constants_1.ADDRESS_ZERO },
        PAX: { name: 'PAX', address: constants_1.ADDRESS_ZERO },
        PAXUSD: { name: 'PAXUSD', address: constants_1.ADDRESS_ZERO },
        RENBTC: { name: 'RENBTC', address: constants_1.ADDRESS_ZERO },
        RETH: { name: 'RETH', address: constants_1.ADDRESS_ZERO },
        RWA001: { name: 'RWA001', address: constants_1.ADDRESS_ZERO },
        RWA002: { name: 'RWA002', address: constants_1.ADDRESS_ZERO },
        RWA003: { name: 'RWA003', address: constants_1.ADDRESS_ZERO },
        RWA004: { name: 'RWA004', address: constants_1.ADDRESS_ZERO },
        RWA005: { name: 'RWA005', address: constants_1.ADDRESS_ZERO },
        RWA006: { name: 'RWA006', address: constants_1.ADDRESS_ZERO },
        STETH: { name: 'STETH', address: constants_1.ADDRESS_ZERO },
        TUSD: { name: 'TUSD', address: constants_1.ADDRESS_ZERO },
        UNI: { name: 'UNI', address: constants_1.ADDRESS_ZERO },
        UNIV2AAVEETH: { name: 'UNIV2AAVEETH', address: constants_1.ADDRESS_ZERO },
        UNIV2DAIETH: { name: 'UNIV2DAIETH', address: constants_1.ADDRESS_ZERO },
        UNIV2DAIUSDC: { name: 'UNIV2DAIUSDC', address: constants_1.ADDRESS_ZERO },
        UNIV2DAIUSDT: { name: 'UNIV2DAIUSDT', address: constants_1.ADDRESS_ZERO },
        UNIV2ETHUSDT: { name: 'UNIV2ETHUSDT', address: constants_1.ADDRESS_ZERO },
        UNIV2LINKETH: { name: 'UNIV2LINKETH', address: constants_1.ADDRESS_ZERO },
        UNIV2UNIETH: { name: 'UNIV2UNIETH', address: constants_1.ADDRESS_ZERO },
        UNIV2USDCETH: { name: 'UNIV2USDCETH', address: constants_1.ADDRESS_ZERO },
        UNIV2WBTCDAI: { name: 'UNIV2WBTCDAI', address: constants_1.ADDRESS_ZERO },
        UNIV2WBTCETH: { name: 'UNIV2WBTCETH', address: constants_1.ADDRESS_ZERO },
        USDC: {
            name: 'USDC',
            address: constants_1.ADDRESS_ZERO,
            serviceRegistryName: 'USDC',
        },
        USDT: { name: 'USDT', address: constants_1.ADDRESS_ZERO },
        WBTC: {
            name: 'WBTC',
            address: constants_1.ADDRESS_ZERO,
        ...
        YFI: { name: 'YFI', address: constants_1.ADDRESS_ZERO },
        ZRX: { name: 'ZRX', address: constants_1.ADDRESS_ZERO },
    },
    aave: {
        v2: {
            PriceOracle: {
