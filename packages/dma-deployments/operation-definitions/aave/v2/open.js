...
exports.aaveOpenV2OperationDefinition = void 0;
const constants_1 = require("@dma-deployments/constants");
const action_hash_1 = require("@dma-deployments/utils/action-hash");
exports.aaveOpenV2OperationDefinition = {
    name: constants_1.OPERATION_NAMES.aave.v2.OPEN_POSITION,
    actions: [
        {
        ...
        {
            hash: (0, action_hash_1.getActionHash)(constants_1.CONTRACT_NAMES.aave.v2.BORROW),
            optional: false,
        },
        {
