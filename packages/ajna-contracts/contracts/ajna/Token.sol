...
contract Token is ERC20, ERC20Burnable {
    ...
    constructor(string memory name, string memory ticker, address tokenReceiver_, uint8 _dec) ERC20(name, ticker) {
    ...
    function _afterTokenTransfer(address from_, address to_, uint256 amount_) internal override(ERC20) {
