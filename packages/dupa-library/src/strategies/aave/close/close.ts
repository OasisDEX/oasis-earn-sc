...
import aaveProtocolDataProviderABI from '@oasisdex/dupa-contracts/abi/external/aave/v2/protocolDataProvider.json'
import aaveV3PriceOracleABI from '@oasisdex/dupa-contracts/abi/external/aave/v3/aaveOracle.json'
import aaveV3ProtocolDataProviderABI from '@oasisdex/dupa-contracts/abi/external/aave/v3/aaveProtocolDataProvider.json'
