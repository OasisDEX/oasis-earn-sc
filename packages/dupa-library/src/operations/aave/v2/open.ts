...
import { IOperation } from '@dupa-library/types/Operations'
import { PositionType } from '@dupa-library/types/PositionType'
import { Protocol } from '@dupa-library/types/Protocol'
