...
import { ActionFactory, ADDRESSES, calldataTypes, CONTRACT_NAMES, OPERATION_NAMES } from '@oasisdex/oasis-actions'
...
async function main() {
    ...
    const tx = await dsProxy['execute(address,bytes)'](system.operationExecutor.address, system.operationExecutor.interface.encodeFunctionData('executeOp', [
        [openVaultAction],
