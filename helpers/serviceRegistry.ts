...
export class ServiceRegistry {
  ...
  async getContractInstance() {
    ...
    return await ethers.getContractAt('ServiceRegistry', this._address, this._signer)
  }
  ...
  async addEntry(label: ContractNames, address: string, debug = false): Promise<string> {
    ...
    const registry = await ethers.getContractAt('ServiceRegistry', this._address, this._signer)
